 ...
 * V E O   S I G N E R
 *
 * This class generates and tests signatures given an input VEO and
 * a PFX file.
 *
 ...
 * produce a signed VEO to compare with one from a vendor.
 * <p>
 * The program generates a VEO given a <signedObject> element (in a
 * source file) and a PFX file (used for both ordinary and lock
 * signatures. A minimal example of usage is<br>
 * <pre>
 *     veosigner -s signer.pfx contents.xml
 * </pre>
 */
public class VEOSigner {
 ...
 * Configure
 *
 * This method configures the VEOSigner from the arguments on the command
...
private void configure(String args[]) {
	int i;
	String usage = "veoCreator -s <pfxFile> [-p <password>] [-o <outputDir>] [-v] signedObject";
	String s;
...
public static void main (String args[]) {
	VEOSigner vs = new VEOSigner(args);
